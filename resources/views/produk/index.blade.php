        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="btn-group">
                    ...
                    @if (auth()->user()->level == 1)<button onclick="deleteSelected('{{ route('produk.delete_selected') }}')" class="btn btn-danger btn-xs btn-flat"><i class="fa fa-trash"></i> Hapus</button>@endif
