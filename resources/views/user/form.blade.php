        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="no_hp" class="col-lg-3 col-lg-offset-1 control-label">No Hp</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="jen_kel" class="col-lg-3 col-lg-offset-1 control-label">Jenis Kelamin</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="tmpt_lahir" class="col-lg-3 col-lg-offset-1 control-label">Tempat Lahir</label>
                        <div class="col-lg-6">
                            <input type="text" name="tmpt_lahir" id="tmpt_lahir" class="form-control" required autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="tgl_lahir" class="col-lg-3 col-lg-offset-1 control-label">Tanggal Lahir</label>
                        <div class="col-lg-6">
